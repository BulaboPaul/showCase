...
$pdf->SetTitle('Talentseekers Report');
$pdf->SetSubject('Talentseekers Data');
$pdf->SetKeywords('TCPDF, Talentseekers, Report');
...
// Add headline
$pdf->Cell(0, 10, 'Talentseekers Report', 0, 1, 'C');
...
$pdf->Output('talentseekers_report.pdf', 'I');
