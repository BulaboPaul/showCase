...
$pdf->SetTitle('Talents Post Report');
$pdf->SetSubject('Talents Post Data');
$pdf->SetKeywords('TCPDF, Talent, Report');
...
// Add headline
$pdf->Cell(0, 10, 'All Talent Posts', 0, 1, 'C');
...
$headers = '<tr>
              ...
              <th style="font-weight:bold;">Talent Title</th>
...
$pdf->Output('talents_post_report.pdf', 'I');
