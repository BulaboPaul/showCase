...
$pdf->SetTitle('Artists Report');
$pdf->SetSubject('Artist Data');
$pdf->SetKeywords('TCPDF, Artist, Report');
...
// Add headline
$pdf->Cell(0, 10, 'All Artists', 0, 1, 'C');
...
$headers = '<tr>
              ...
              <th style="font-weight:bold;">Artist Name</th>
...
$pdf->Output('artist_report.pdf', 'I');
