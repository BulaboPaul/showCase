...
<body>
  ...
  <div class="dashboard-container">
    ...
    <div class="manage-jobs-container">
      <div class="headline">
        <h3>Who Applied your Talents</h3>
      </div>
      <?php
      ...
      $sql =  "SELECT  * FROM applied_jobposts WHERE id_company = '$id_company' ";
      ...
      ?>
            <div class="job-item-container">
              ...
              <div class="job-info-container">
                ...
                echo '<div><a class="validity-active btn-green" href="viewApplications.php?hash=' . md5($id_jobpost) . '&id=' . $id_jobpost . '" >' . $query2->num_rows . ' Applications <i class="fa-regular fa-eye" style="color:white; font-size:.85rem;" ></i></a></div>';
                ?>
                <div class="title-with-status">
                  <h3><?php echo $row1["jobtitle"] ?></h3>
