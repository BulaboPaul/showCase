    ...
    <div class="add-job-container">
      <div class="add-job-content-container">
        ...
        ?>
          ...
          <form class="job-form-container" method="post" action="../process/updateTalent.php?key=<?php echo $hash . '&id=' . $id_jobpost ?>">
            ...
            <div class="button-container item-n">
              <button type="submit" name="updateJob" class="btn btn-secondary">Update Talent</button>
            </div>
          </form>
        <?php endif; ?>
      </div>
