  ...
  <div class="dashboard-container">
    ...
    <div class="all-jobs-container">
      <div class="headline headline-container">
        <h3>All Talent Posts</h3>
        <a href="../Report Generation/Admin/report-for-talentposts.php" class="btn"><i class="fa-solid fa-download"></i> Generate Report</a>
      </div>
      <div>
        <table>
          <thead>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              echo "
                              <tr>
                                ...
                                <td>" . $city_id[0] . "</td>
                                <td>" . $company[0] . "</td>
                                <td class='action-button' ><a class='btn btn-optional' href='../talentDetails.php?key=" . $hash . "&id=" . $job_id . "'>View</a>
                                <a href='../process/deleteTalents.php?key=" . $hash . "&id=" . $job_id . "&page=admin-control' class='btn btn-optional'>Remove </a> 
                                </td>
                                </tr>";
              $i++;
            }
