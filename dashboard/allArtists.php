  ...
  <div class="dashboard-container">
    ...
    <div class="all-jobs-container">
      <div class="headline headline-container">
        <h3>All Artists</h3>
        <a href="../Report Generation/Admin/report-for-artists.php" class="btn"><i class="fa-solid fa-download"></i> Generate Report</a>
      </div>
      <div>
        <table>
          <thead>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              echo "
                              <tr>
                                ...
                                <a class='btn btn-optional' href='../artistDetails.php?key=" . $hash . "&id=" . $company_id . "'>View</a>
                                <a href='../process/deleteArtist.php?key=" . $hash . "&id=" . $company_id . "&page=admin-control' class='btn btn-optional'>Remove </a> 
                                </td>
                                </tr>";
              $i++;
            }
