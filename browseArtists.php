  ...
  <div id="browse-company-page">
        ...
        <div class="intro-banner-content">
          <div class="container glassmorphism">
            <div class="banner-headline-text-part">
              ...
              <span>Discover a diverse range of v and explore their offerings. Whether you're seeking talents or looking to learn more about different industries, our curated list of artists has got you covered.</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="page-content">
      <div class="page-content-left-side">
        <?php include "./includes/searchSidebarArtist.php" ?>
      </div>
      ...
      <div class="page-content-right-side">
        ...
        ?>
          <a href="./artistDetails.php?key=<?php echo $hash . '&id=' . $id_company ?>">
